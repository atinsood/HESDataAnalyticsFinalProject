...
public class Tweet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Tweet\",\"namespace\":\"edu.harvard.twitter.schema\",\"fields\":[{\"name\":\"tweetId\",\"type\":\"int\"},{\"name\":\"user\",\"type\":\"string\"},{\"name\":\"text\",\"type\":\"string\"},{\"name\":\"hashtags\",\"type\":{\"type\":\"array\",\"items\":\"string\"}}]}");
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Tweet>
    ...
    /** Sets the value of the 'hashtags' field */
    public edu.harvard.twitter.schema.Tweet.Builder setHashtags(java.util.List<java.lang.CharSequence> value) {
    ...
    public edu.harvard.twitter.schema.Tweet.Builder clearHashtags() {
      hashtags = null;
